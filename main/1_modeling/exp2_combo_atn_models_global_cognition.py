...
from experiments import experiment_combo_atn_vs_baseline
...
def main(rerun=False, plot=True):
    ...
    if rerun or (not results_exist):
        ...
        dataset = pd.read_csv('../../outputs/maindata/maindata.csv')
        _ = experiment_combo_atn_vs_baseline(dataset,
                                             target=target,
    ...
    if plot:
        ...
        fig, _ = results_boxplot(data, groupby='model', baseline='Baseline',
