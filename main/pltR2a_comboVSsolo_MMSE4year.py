...
# load data
biomarkers = load_results('expR2a_comboVSsolo_MMSE4year', 'results.csv')
svm = load_results('expR2c_svm_MMSE4year', 'results.csv')
...
positions = [1.0, 1.05, 1.1] * 4 + [1.15, 1.2, 1.25]
