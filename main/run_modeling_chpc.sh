...
SCRIPTS=('exp0_individual_atn_models_global_cognition.py'
         ...
         'exp8c_combo_atn_models_longitudinal_cognition_vs_covariates.py'
         'exp9a_CU_combo_atn_models.py'
         'exp9b_CU_combo_atn_models_vs_binary.py'
         'exp9c_CU_svms.py'
         'exp9d_CI_combo_atn_models.py'
         'exp9e_CI_combo_atn_models_vs_binary.py'
         'exp9f_CI_svms.py'
